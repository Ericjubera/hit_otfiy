...
u1 = User.create(name:"uska",password_digest:"12345",age:21)
u2 = User.create(name:"chris",password_digest:"1234567",age:22)
u3 = User.create(name:"jesus",password_digest:"12345789",age:19)
u4 = User.create(name:"kiwi",password_digest:"123457890",age:30)
     ...
     p2= Pipe.create(item_name:"DOUBLE PICKLE RICKKKK",color:"green",size:"small",image: "https://cdn.shopify.com/s/files/1/2105/7969/products/image_3002bc7a-2edf-4a66-85b7-347bc0b9deac_1024x1024@2x.jpg?v=1589215001")
      ...
      Hit.create(user_id: u2.id, pipe_id: p1.id, time:Time.now)
